...
- (instancetype)initWithCellConfigurations:(NSArray *)cellConfig actionText:(NSString *)actionText animatePlaceholders:(BOOL)animatePlaceholders withCancel:(BOOL)cancelFlag handler:(void (^)(NSDictionary *resultDictionary))handler {
    ...
    self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:118.0/255.0 green:206.0/255.0 blue:94.0/255.0 alpha:1.0];

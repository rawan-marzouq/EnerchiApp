...
{
    textLabel.frame = CGRectMake(0, 0, self.frame.size.width, 10);
    backgroundView.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height);
    
    self.dataLabel.frame = CGRectMake(0, 5, self.frame.size.width , 25);
    
    CGFloat sizeCircle = MAX(self.frame.size.width, self.frame.size.height);
    ...
    circleView.frame = CGRectMake(2, -7, sizeCircle, sizeCircle);
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    if(selected){
        if(!self.isOtherMonth){
            ...
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorSelected];
            ...
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorSelectedOtherMonth];
        ...
        if(!self.isOtherMonth){
            circleView.color = [UIColor colorWithRed:118.0/255.0 green:206.0/255.0 blue:94.0/255.0 alpha:0.7];
            textLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorToday];
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorToday];
            ...
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorTodayOtherMonth];
        ...
        if(!self.isOtherMonth){
            ...
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColor];
            ...
            self.dataLabel.textColor = [self.calendarManager.calendarAppearance dayTextColorOtherMonth];
...
- (void)reloadAppearance
{
    ...
    self.dataLabel.font = [UIFont boldSystemFontOfSize:11];
